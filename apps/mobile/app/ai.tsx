...
export default function AiScreen() {
  ...
  async function ask() {
    ...
    try { const result = await mobileApi.askAi((await getToken()) || '', question.trim(), conversationId || undefined); setConversationId(result.conversationId || ''); setAnswer(result.answer); setProposals(result.proposals || []); setCreatedTaskId(''); setQuestion(''); }
